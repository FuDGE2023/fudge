...
def get_args():
  ...
  parser.add_argument('--bias', default=1e-5, type=float, help='the hyperparameter alpha controlling sampling preference with time closeness, default to 0 which is uniform sampling')
  ...
  parser.add_argument('--ngh_dim', type=str, default=4, help='dimension of the neighborhood representation')
