...
def get_split(dataset_name, train_percentage, g_df):
  ...
  del train_set, test_set, val_set
  ...
  for dataset in datasets:
    for ngh_dim in ngh_dims:
      ...
      for n_degree in n_degrees:
        ...
        print(train_percentage, dataset, ngh_dim, n_degree)
        ...
        for run in range(args.run):
          ...
          if args.mode == 'i':
            all_train_val_src_l, all_train_val_tgt_l, all_train_val_ts_l, all_train_val_e_idx_l, all_train_val_label_l = src_l[:train_size_regression],\
                                                                                                                         tgt_l[:train_size_regression],\
                                                                                                                         ts_l[:train_size_regression],\
                                                                                                                         e_idx_l[:train_size_regression],\
                                                                                                                         label_l[:train_size_regression]
          ...
          save_oneline_result('log/', args, [test_acc, test_auc, test_ap, test_new_new_acc, test_new_new_ap, test_new_new_auc, test_new_old_acc, test_new_old_ap, test_new_old_auc], dataset, n_degree)
